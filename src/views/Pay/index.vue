  ...
  methods: {
    async submit() {
      ...
      QRCode.toDataURL(result.codeUrl)
        .then((url) => {
          ...
          this.$alert(
            ...
            "请使用微信扫码支付",
            {
              ...
              showConfirmButton: "我已成功支付",
              cancelButtonClass: "支付过程中出现问题",
              center: true,
            ...
            .catch(() => {
              console.log(this.$message, 999999999999);
              this.$message({
                type: "info",
                message: "已取消",
              });
        ...
        .catch(() => {
          console.log(this.$message, "000000000000000");
